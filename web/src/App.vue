...
type View = 'buckets' | 'files' | 'keys' | 'activity' | 'users' | 'cluster' | 'settings';
...
const searchPlaceholder = computed(() => {
  ...
  if (view.value === 'keys' || view.value === 'users' || view.value === 'cluster' || view.value === 'settings') return 'busca indisponível aqui';
